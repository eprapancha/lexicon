...
1. **STOP and check existing:** `gh label list | grep ':'`
2. **Check if category exists** (priority, type, component, status, phase)
...
- Use existing category: `type:bug`, `priority:high`
