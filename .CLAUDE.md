...
- [#85](https://github.com/eprapancha/lexicon/issues/85) - Fast test mode (reuse browser) - **priority:high**

**Decision:** Tackle testing infrastructure (#81) before adding more Emacs tests - inefficient tooling is slowing development.
