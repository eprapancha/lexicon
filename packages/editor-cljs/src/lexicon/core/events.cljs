(ns lexicon.core.events
  (:require [re-frame.core :as rf]
            ...
            [lexicon.core.events.keymap]
            [lexicon.core.events.mode]
            [lexicon.core.events.wasm]
            [lexicon.core.events.buffer :as buffer-events]
            [lexicon.core.events.edit]
            [lexicon.core.events.ui]
            [lexicon.core.events.command]
            [lexicon.core.events.isearch]
            [lexicon.core.events.message]  ; Issue #47: Message system
            [lexicon.core.events.window]   ; Window management (splitting, deletion)
            [lexicon.core.events.text-properties]  ; Text properties system (DIRED_CORE_PRIMITIVES_ANALYSIS.md - Priority 1)
            [lexicon.core.events.hooks]))  ; Hook system (DIRED_CORE_PRIMITIVES_ANALYSIS.md - Priority 4)
...
(rf/reg-event-db
 ...
 (fn [_ _]
   "Initialize the application database with default state.
    Note: :initialize-commands must be called separately after this event."
   db/default-db))
