#+TITLE: Emacs Compatibility Contract
...
If code behavior and this contract disagree, *this contract wins*. Changes to this document require explicit review and justification.
...
This document defines the *semantic foundation* upon which Lexicon is built. All higher-level features, packages, and extensions depend on the guarantees made here.
